...
public class SVG
{
   ...
   {
      return new SVG(SvgRenderingBase.getFromInputStream(is));
   }
   ...
   {
      return new SVG(SvgRenderingBase.getFromString(svg));
   }
   ...
   {
      return new SVG(SvgRenderingBase.getFromResource(resources, resourceId));
   }
   ...
   {
      return new SVG(SvgRenderingBase.getFromAsset(assetManager, filename));
   }
   ...
   {
      return SvgRenderingBase.parsePath(pathDefinition);
   }
   ...
   {
      SvgRenderingBase.setInternalEntitiesEnabled(enable);
   }
   ...
   {
      SvgRenderingBase.registerExternalFileResolver(fileResolver);
   }
   ...
   {
      SvgRenderingBase.deregisterExternalFileResolver();
   }
