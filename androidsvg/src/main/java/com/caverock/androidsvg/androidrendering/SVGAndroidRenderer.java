...
import com.caverock.androidsvg.model.GraphicsElement;
...
import com.caverock.androidsvg.model.Matrix.MultiplyMatrix;
import com.caverock.androidsvg.model.Matrix.Rotation;
import com.caverock.androidsvg.model.Matrix.Scale;
import com.caverock.androidsvg.model.Matrix.Skew;
import com.caverock.androidsvg.model.Matrix.Transform;
import com.caverock.androidsvg.model.Matrix.Translation;
import com.caverock.androidsvg.model.NotDirectlyRendered;
...
import com.caverock.androidsvg.parser.CSSParser;
import com.caverock.androidsvg.model.PathDefinition;
import com.caverock.androidsvg.model.PathInterface;
...
//import com.caverock.androidsvg.model.Style.CSSBlendMode;
import com.caverock.androidsvg.model.Style.FontStyle;
import com.caverock.androidsvg.model.Style.Isolation;
import com.caverock.androidsvg.model.Style.RenderQuality;
import com.caverock.androidsvg.model.Style.TextAnchor;
import com.caverock.androidsvg.model.Style.TextDecoration;
import com.caverock.androidsvg.model.Style.VectorEffect;
...
//   private static final boolean  SUPPORTS_PAINT_WORD_SPACING = Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q;
   ...
   // Renderer state
   private SvgRenderingBase document;
    ...
    */
   void  renderDocument(SvgRenderingBase document, RenderOptionsBase renderOptions)
   {
      ...
      if (renderOptions.hasCss()) {
         CSSParser  parser = new CSSParser(new AndroidLogger(), Source.RenderOptions, externalFileResolver);
      ...
      if (rootObj.width != null)
         viewPort.width = computeFloatValue(rootObj.width, this, viewPort.width);
      if (rootObj.height != null)
         viewPort.height = computeFloatValue(rootObj.height, this, viewPort.height);
   ...
   private void  render(SvgObject obj)
   {
      ...
      if (obj instanceof Svg) {
         ...
         render((Image) obj);
      } else if (obj instanceof com.caverock.androidsvg.model.Path) {
         render((com.caverock.androidsvg.model.Path) obj);
   ...
   private void updateStyleForElement(RendererState state, SvgElementBase obj)
   {
      ...
      {
         for (Rule rule: document.getCSSRules())
         {
...
//         Log.d(TAG, String.format(format, args));
   ...
   */
   ...
   {
      float  _x = (x != null) ? computeFloatValueX(x, this) : 0f;
      float  _y = (y != null) ? computeFloatValueY(y, this) : 0f;

      Box viewPortUser = getCurrentViewPortInUserUnits();
      float  _w = (width != null) ? computeFloatValueX(width, this) : viewPortUser.width;  // default 100%
      float  _h = (height != null) ? computeFloatValueY(height, this) : viewPortUser.height;
   ...
   private void render(Group obj)
   {
      ...
      if (obj.transform != null) {
         canvas.concat(convertFromModelMatrix(obj.transform));
      }
...
//   ==============================================================================
   ...
   private void render(Use obj)
   {
      ...
      SvgObject  ref = ((SvgRenderingBase) obj.document).resolveIRI(obj.href);
      if (ref == null) {
      ...
      float _x = (obj.x != null) ? computeFloatValueX(obj.x, this) : 0f;
      float _y = (obj.y != null) ? computeFloatValueY(obj.y, this) : 0f;
   ...
   private void render(com.caverock.androidsvg.model.Path obj)
   {
      debug("Path render");
   ...
   private List<MarkerVector>  calculateMarkerPositions(Line obj)
   {
      ...
      _x1 = (obj.x1 != null) ? computeFloatValueX(obj.x1, this) : 0f;
      _y1 = (obj.y1 != null) ? computeFloatValueY(obj.y1, this) : 0f;
      _x2 = (obj.x2 != null) ? computeFloatValueX(obj.x2, this) : 0f;
      _y2 = (obj.y2 != null) ? computeFloatValueY(obj.y2, this) : 0f;
   ...
   private void render(Text obj)
   {
      ...
      float  x = (obj.x == null || obj.x.size() == 0) ? 0f : computeFloatValueX(obj.x.get(0), this);
      float  y = (obj.y == null || obj.y.size() == 0) ? 0f : computeFloatValueY(obj.y.get(0), this);
      float  dx = (obj.dx == null || obj.dx.size() == 0) ? 0f : computeFloatValueX(obj.dx.get(0), this);
      float  dy = (obj.dy == null || obj.dy.size() == 0) ? 0f : computeFloatValueY(obj.dy.get(0), this);
   ...
   private class  PlainTextDrawer extends TextProcessor
   {
      ...
      public void processText(String text)
      {
         ...
         if (visible())
         {
            ...
            float letterspacingAdj = SUPPORTS_PAINT_LETTER_SPACING ? computeFloatValue(state.style.letterSpacing, SVGAndroidRenderer.this) / 2 : 0;
            if (state.hasFill)
   ...
   private void  processTextChild(SvgObject obj, TextProcessor textprocessor)
   {
      ...
      else if (obj instanceof TSpan)
      {
         ...
         if (display())
         {
            ...
            if (textprocessor instanceof PlainTextDrawer) {
               x = !specifiedX ? ((PlainTextDrawer) textprocessor).x : computeFloatValueX(tspan.x.get(0), this);
               y = (tspan.y == null || tspan.y.size() == 0) ? ((PlainTextDrawer) textprocessor).y : computeFloatValueY(tspan.y.get(0), this);
               dx = (tspan.dx == null || tspan.dx.size() == 0) ? 0f : computeFloatValueX(tspan.dx.get(0), this);
               dy = (tspan.dy == null || tspan.dy.size() == 0) ? 0f : computeFloatValueY(tspan.dy.get(0), this);
            }
      ...
      else if  (obj instanceof TRef)
      {
         ...
         if (display())
         {
            ...
            // Locate the referenced object
            SvgObject  ref = ((SvgRenderingBase) obj.document).resolveIRI(tref.href);
   ...
   private void renderTextPath(TextPath obj)
   {
      ...
      com.caverock.androidsvg.model.Path pathObj = (com.caverock.androidsvg.model.Path) ref;
      Path          path = (new PathConverter(pathObj.d)).getPath();

      if (pathObj.transform != null)
         path.transform(convertFromModelMatrix(pathObj.transform));

      PathMeasure  measure = new PathMeasure(path, false);

      float  startOffset = (obj.startOffset != null) ? computeFloatValue(obj.startOffset, this, measure.getLength()) : 0f;
   ...
   private class  TextBoundsCalculator extends TextProcessor
   {
      ...
      public boolean doTextContainer(TextContainer obj)
      {
         if (obj instanceof TextPath)
         {
            ...
            SvgObject  ref = ((SvgRenderingBase) obj.document).resolveIRI(tpath.href);
            if (ref == null) {
   ...
   private void render(Image obj)
   {
      ...
      float  _x = (obj.x != null) ? computeFloatValueX(obj.x, this) : 0f;
      float  _y = (obj.y != null) ? computeFloatValueY(obj.y, this) : 0f;
      float  _w = computeFloatValueX(obj.width, this);
      float  _h = computeFloatValueX(obj.height, this);
   ...
   private void  updateStyle(RendererState state, Style style)
   {
      ...
      if (isSpecified(style, Style.SPECIFIED_STROKE_WIDTH))
      {
         ...
         state.strokePaint.setStrokeWidth(computeFloatValue(state.style.strokeWidth, this));
      }
      ...
      if (isSpecified(style, Style.SPECIFIED_STROKE_DASHARRAY | Style.SPECIFIED_STROKE_DASHOFFSET))
      {
         ...
         else
         {
            ...
            for (int i=0; i<arrayLen; i++) {
               intervals[i] = computeFloatValue(state.style.strokeDashArray[i % n], this);
               intervalSum += intervals[i];
            }
            if (intervalSum == 0f) {
               state.strokePaint.setPathEffect(null);
            } else {
               float offset = computeFloatValue(state.style.strokeDashOffset, this);
               if (offset < 0) {
      ...
      if (isSpecified(style, Style.SPECIFIED_FONT_SIZE))
      {
         ...
         state.fillPaint.setTextSize(computeFloatValue(style.fontSize, this, currentFontSize));
         state.strokePaint.setTextSize(computeFloatValue(style.fontSize, this, currentFontSize));
      }
      ...
      if (isSpecified(style, Style.SPECIFIED_LETTER_SPACING))
      {
         ...
         if (SUPPORTS_PAINT_LETTER_SPACING) {
            ...
            state.fillPaint.setLetterSpacing(computeFloatValue(style.letterSpacing, this) / getCurrentFontSize());
            state.strokePaint.setLetterSpacing(computeFloatValue(style.letterSpacing, this) / getCurrentFontSize());
         }
      }
...
//         }
   ...
   private void  setClipRect(float minX, float minY, float width, float height)
   {
      ...
      if (state.style.clip != null) {
         left += computeFloatValueX(state.style.clip.left, this);
         top += computeFloatValueY(state.style.clip.top, this);
         right -= computeFloatValueX(state.style.clip.right, this);
         bottom -= computeFloatValueY(state.style.clip.bottom, this);
      }
   ...
   private void  renderMarkers(GraphicsElement obj)
   {
      ...
      if (state.style.markerStart != null) {
         SvgObject  ref = ((SvgRenderingBase) obj.document).resolveIRI(state.style.markerStart);
         if (ref != null)
      ...
      if (state.style.markerMid != null) {
         SvgObject  ref = ((SvgRenderingBase) obj.document).resolveIRI(state.style.markerMid);
         if (ref != null)
      ...
      if (state.style.markerEnd != null) {
         SvgObject  ref = ((SvgRenderingBase) obj.document).resolveIRI(state.style.markerEnd);
         if (ref != null) {
      ...
      if (obj instanceof com.caverock.androidsvg.model.Path)
         markers = (new MarkerPositionCalculator(((com.caverock.androidsvg.model.Path) obj).d)).getMarkers();
      else if (obj instanceof Line)
   ...
   private void renderMarker(Marker marker, MarkerVector pos)
   {
      ...
      unitsScale = marker.markerUnitsAreUser ? 1f : computeFloatValue(state.style.strokeWidth, dpi, state.textPaint);
      ...
      float _refX = (marker.refX != null) ? computeFloatValueX(marker.refX, this) : 0f;
      float _refY = (marker.refY != null) ? computeFloatValueY(marker.refY, this) : 0f;
      float _markerWidth = (marker.markerWidth != null) ? computeFloatValueX(marker.markerWidth, this) : 3f;
      float _markerHeight = (marker.markerHeight != null) ? computeFloatValueY(marker.markerHeight, this) : 3f;
   ...
   private void  makeLinearGradient(boolean isFill, Box boundingBox, SvgLinearGradient gradient)
   {
      ...
      {
          Box  viewPortUser = getCurrentViewPortInUserUnits();
         _x1 = (gradient.x1 != null) ? computeFloatValueX(gradient.x1, this) : 0f;
         _y1 = (gradient.y1 != null) ? computeFloatValueY(gradient.y1, this) : 0f;
         _x2 = (gradient.x2 != null) ? computeFloatValueX(gradient.x2, this) : viewPortUser.width; // 100%
         _y2 = (gradient.y2 != null) ? computeFloatValueY(gradient.y2, this) : 0f;
      }
      else
      {
         _x1 = (gradient.x1 != null) ? computeFloatValue(gradient.x1, this, 1f) : 0f;
         _y1 = (gradient.y1 != null) ? computeFloatValue(gradient.y1, this, 1f) : 0f;
         _x2 = (gradient.x2 != null) ? computeFloatValue(gradient.x2, this, 1f) : 1f;
         _y2 = (gradient.y2 != null) ? computeFloatValue(gradient.y2, this, 1f) : 0f;
      }
      ...
      {
         m.preConcat(convertFromModelMatrix(gradient.gradientTransform));
      }
   ...
   private void  makeRadialGradient(boolean isFill, Box boundingBox, SvgRadialGradient gradient)
   {
      ...
      if (userUnits)
      {
         ...
         _cx = (gradient.cx != null) ? computeFloatValueX(gradient.cx, this) : computeFloatValueX(fiftyPercent, this);
         _cy = (gradient.cy != null) ? computeFloatValueY(gradient.cy, this) : computeFloatValueY(fiftyPercent, this);
         _r = (gradient.r != null) ? computeFloatValue(gradient.r, this) : computeFloatValue(fiftyPercent, this);
      }
      else
      {
         _cx = (gradient.cx != null) ? computeFloatValue(gradient.cx, this, 1f) : 0.5f;
         _cy = (gradient.cy != null) ? computeFloatValue(gradient.cy, this, 1f) : 0.5f;
         _r = (gradient.r != null) ? computeFloatValue(gradient.r, this, 1f) : 0.5f;
      }
   ...
   {
      // Locate the referenced object
      SvgObject  ref = ((SvgRenderingBase) gradient.document).resolveIRI(href);
      if (ref == null) {
         // Non-existent
   ...
   {
      // Locate the referenced object
      SvgObject  ref = ((SvgRenderingBase) obj.document).resolveIRI(state.style.clipPath);
      if (ref == null) {
      ...
      {
         m.preConcat(convertFromModelMatrix(clipPath.transform));
      }
   ...
   private Path objectToPath(SvgElement obj, boolean allowUse)
   {
      ...
      if (obj instanceof Use)
      {
         ...
         SvgObject  ref = ((SvgRenderingBase) obj.document).resolveIRI(useElement.href);
         if (ref == null) {
         ...
         if (useElement.transform != null)
            path.transform(convertFromModelMatrix(useElement.transform));
      }
      else if (obj instanceof GraphicsElement)
      {
         ...
         if (obj instanceof com.caverock.androidsvg.model.Path)
         {
            com.caverock.androidsvg.model.Path pathElem = (com.caverock.androidsvg.model.Path) obj;
         ...
         if (elem.transform != null)
            path.transform(convertFromModelMatrix(elem.transform));
      ...
      else if (obj instanceof Text)
      {
         ...
         if (textElem.transform != null)
            path.transform(convertFromModelMatrix(textElem.transform));
   ...
   private void checkForClipPath_OldStyle(SvgElement obj, Box boundingBox)
   {
      ...
      if (clipPath.transform != null)
      {
         canvas.concat(convertFromModelMatrix(clipPath.transform));
      }
   ...
   private void addObjectToClip(SvgObject obj, boolean allowUse, Path combinedPath, Matrix combinedPathMatrix)
   {
      ...
      if (obj instanceof Use) {
         ...
         addObjectToClip((com.caverock.androidsvg.model.Path) obj, combinedPath, combinedPathMatrix);
      } else if (obj instanceof Text) {
   ...
   private void addObjectToClip(com.caverock.androidsvg.model.Path obj, Path combinedPath, Matrix combinedPathMatrix)
   {
      updateStyleForElement(state, obj);
      ...
      if (obj.transform != null)
         combinedPathMatrix.preConcat(convertFromModelMatrix(obj.transform));
   ...
   {
      float x1 = (obj.x1 == null) ? 0 : computeFloatValueX(obj.x1, this);
      float y1 = (obj.y1 == null) ? 0 : computeFloatValueY(obj.y1, this);
      float x2 = (obj.x2 == null) ? 0 : computeFloatValueX(obj.x2, this);
      float y2 = (obj.y2 == null) ? 0 : computeFloatValueY(obj.y2, this);
   ...
   private Path  makePathAndBoundingBox(Rect obj)
   {
      ...
      if (obj.rx == null && obj.ry == null) {
         ...
         rx = ry = computeFloatValueY(obj.ry, this);
      } else if (obj.ry == null) {
         rx = ry = computeFloatValueX(obj.rx, this);
      } else {
         rx = computeFloatValueX(obj.rx, this);
         ry = computeFloatValueY(obj.ry, this);
      }
      rx = Math.min(rx, computeFloatValueX(obj.width, this) / 2f);
      ry = Math.min(ry, computeFloatValueY(obj.height, this) / 2f);
      x = (obj.x != null) ? computeFloatValueX(obj.x, this) : 0f;
      y = (obj.y != null) ? computeFloatValueY(obj.y, this) : 0f;
      w = computeFloatValueX(obj.width, this);
      h = computeFloatValueY(obj.height, this);
   ...
   {
      float  cx = (obj.cx != null) ? computeFloatValueX(obj.cx, this) : 0f;
      float  cy = (obj.cy != null) ? computeFloatValueY(obj.cy, this) : 0f;
      float  r = computeFloatValue(obj.r, this);
   ...
   private Path makePathAndBoundingBox(Ellipse obj)
   {
      float  cx = (obj.cx != null) ? computeFloatValueX(obj.cx, this) : 0f;
      float  cy = (obj.cy != null) ? computeFloatValueY(obj.cy, this) : 0f;
      float  rx = computeFloatValueX(obj.rx, this);
      float  ry = computeFloatValueY(obj.ry, this);
   ...
   private void  fillWithPattern(SvgElement obj, Path path, Pattern pattern)
   {
      ...
      {
         x = (pattern.x != null) ? computeFloatValueX(pattern.x, this) : 0f;
         y = (pattern.y != null) ? computeFloatValueY(pattern.y, this) : 0f;
         w = (pattern.width != null) ? computeFloatValueX(pattern.width, this) : 0f;
         h = (pattern.height != null) ? computeFloatValueY(pattern.height, this) : 0f;
      }
      else
      {
         // Convert objectBoundingBox space to user space
         x = (pattern.x != null) ? computeFloatValue(pattern.x, this, 1f) : 0f;
         y = (pattern.y != null) ? computeFloatValue(pattern.y, this, 1f) : 0f;
         w = (pattern.width != null) ? computeFloatValue(pattern.width, this, 1f) : 0f;
         h = (pattern.height != null) ? computeFloatValue(pattern.height, this, 1f) : 0f;
      ...
      {
         canvas.concat(convertFromModelMatrix(pattern.patternTransform));
         ...
         if (convertFromModelMatrix(pattern.patternTransform).invert(inverse)) {
            float[] pts = {obj.boundingBox.minX, obj.boundingBox.minY,
                           obj.boundingBox.maxX(), obj.boundingBox.minY,
                           obj.boundingBox.maxX(), obj.boundingBox.maxY(),
                           obj.boundingBox.minX, obj.boundingBox.maxY()};
   ...
   {
      // Locate the referenced object
      SvgObject  ref = ((SvgRenderingBase) pattern.document).resolveIRI(href);
      if (ref == null) {
         // Non-existent
   ...
   private void  renderMask(Mask mask, SvgElement obj, Box originalObjBBox)
   {
      ...
      if (maskUnitsAreUser)
      {
         w = (mask.width != null) ? computeFloatValueX(mask.width, this) : originalObjBBox.width;
         h = (mask.height != null) ? computeFloatValueY(mask.height, this) : originalObjBBox.height;
      ...
      else
      {
         ...
         w = (mask.width != null) ? computeFloatValue(mask.width, this, 1f) : 1.2f;
         h = (mask.height != null) ? computeFloatValue(mask.height, this, 1f) : 1.2f;
   ...
   private static float computeFloatValueX(Length length, SVGAndroidRenderer renderer) {
      switch (length.unit) {
         case em:
            return length.floatValue() * renderer.getCurrentFontSize();
         case ex:
            return length.floatValue() * renderer.getCurrentFontXHeight();
         case in:
            return length.floatValue() * renderer.getDPI();
         case cm:
            return length.floatValue() * renderer.getDPI() / 2.54f;
         case mm:
            return length.floatValue() * renderer.getDPI() / 25.4f;
         case pt: // 1 point = 1/72 in
            return length.floatValue() * renderer.getDPI() / 72f;
         case pc: // 1 pica = 1/6 in
            return length.floatValue() * renderer.getDPI() / 6f;
         case percent:
            Box viewPortUser = renderer.getCurrentViewPortInUserUnits();
            if (viewPortUser == null)
               return length.floatValue();  // Undefined in this situation - so just return value to avoid an NPE
            return length.floatValue() * viewPortUser.width / 100f;
         case px:
         default:
   ...
   private static float computeFloatValueY(Length length, SVGAndroidRenderer renderer) {
      if (length.unit == Unit.percent) {
         Box viewPortUser = renderer.getCurrentViewPortInUserUnits();
         if (viewPortUser == null)
            return length.floatValue();  // Undefined in this situation - so just return value to avoid an NPE
         return length.floatValue() * viewPortUser.height / 100f;
      }
      return computeFloatValueX(length, renderer);
   }

   // Convert length to user units for a context that is not orientation specific.
   // For example, stroke width.
   private static float computeFloatValue(Length length, SVGAndroidRenderer renderer) {
      if (length.unit == Unit.percent) {
         Box viewPortUser = renderer.getCurrentViewPortInUserUnits();
         if (viewPortUser == null)
            return length.floatValue();  // Undefined in this situation - so just return value to avoid an NPE
         ...
         if (w == h)
            return length.floatValue() * w / 100f;
         float n = (float) (Math.sqrt(w * w + h * h) / Length.SQRT2);  // see spec section 7.10
         return length.floatValue() * n / 100f;
      }
      return computeFloatValueX(length, renderer);
   }
   ...
   private static float computeFloatValue(Length length, SVGAndroidRenderer renderer, float max) {
      if (length.unit == Unit.percent) {
         return length.floatValue() * max / 100f;
      }
      return computeFloatValueX(length, renderer);
   }
   ...
   public static float computeFloatValue(Length length, float dpi, TextPaint textPaint) {
      switch (length.unit) {
         case in:
            return length.floatValue() * dpi;
         case cm:
            return length.floatValue() * dpi / 2.54f;
         case mm:
            return length.floatValue() * dpi / 25.4f;
         case pt: // 1 point = 1/72 in
            return length.floatValue() * dpi / 72f;
         case pc: // 1 pica = 1/6 in
            return length.floatValue() * dpi / 6f;
         case em:
            return textPaint != null ? textPaint.getTextSize() * length.floatValue() : length.floatValue();
         case ex:
            // The CSS3 spec says to use 0.5em if there is no way to determine true x-height;
            return textPaint != null ? textPaint.getTextSize() * length.floatValue() * 0.5f : length.floatValue();
         case px:
         case percent:
         default:
            return length.floatValue();
   ...
   private static Matrix convertFromModelMatrix(com.caverock.androidsvg.model.Matrix modelMatrix) {
      Matrix baseMatrix = new Matrix();
      baseMatrix.setValues(modelMatrix.values);
      for (Transform transform : modelMatrix.preTransforms) {
         if (transform instanceof MultiplyMatrix) {
            baseMatrix.preConcat(convertFromModelMatrix(((MultiplyMatrix) transform).other));
         } else if (transform instanceof Rotation) {
            Rotation rotation = (Rotation) transform;
            baseMatrix.preRotate(rotation.angleRads, rotation.centerX, rotation.centerY);
         } else if (transform instanceof Scale) {
            Scale scale = (Scale) transform;
            baseMatrix.preScale(scale.scaleX, scale.scaleY);
         } else if (transform instanceof Translation) {
            Translation translation = (Translation) transform;
            baseMatrix.preTranslate(translation.translateX, translation.translateY);
         } else if (transform instanceof Skew) {
            Skew skew = (Skew) transform;
            baseMatrix.preSkew(skew.angleRadsX, skew.angleRadsY);
         } else throw new IllegalStateException("Unsupported pre-transform: " + transform);
      }
      return baseMatrix;
   }
}
