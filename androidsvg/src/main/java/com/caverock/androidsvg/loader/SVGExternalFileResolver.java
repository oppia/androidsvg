...
public interface SVGExternalFileResolver extends CssResolver {
   /**
    ...
    */
   Typeface resolveFont(String fontFamily, float fontWeight, String fontStyle, float fontStretch);
